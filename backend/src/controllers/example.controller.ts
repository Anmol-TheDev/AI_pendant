...
export const getExampleById = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
    const { id } = req.params;
    const example = await exampleService.getExampleById(id as string);
    const exampleDto = toExampleDto(example);
...
export const updateExample = asyncHandler(
  async (
    ...
    const { id } = req.params;
    const example = await exampleService.updateExample(id as string, req.body);
    const exampleDto = toExampleDto(example);
...
export const getExamplesByCategory = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
    ...
    const examples = await exampleService.getExamplesByCategory(category as string);
